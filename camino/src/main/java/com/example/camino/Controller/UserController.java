...
public class UserController {
    ...
    public ResponseEntity addUser(@RequestBody @Valid User user){
        ...
        logger.info("Oi  you are in addUser method");
        return  ResponseEntity.status(HttpStatus.OK).body("User added");
    }

    @PutMapping("/update/{id}/{pass}")
    public ResponseEntity updateUser(@PathVariable Integer id , @PathVariable String pass , @RequestBody User user){
        logger.info("Oi it's updateUser");
